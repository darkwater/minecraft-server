...
use crate::protocol::{DecodeError, Encodable, Decodable};
...
mod tests {
    ...
    fn encode_longs() {
        ...
        assert_eq!(
            encode_long(9223372036854775807),
        ...
        assert_eq!(
            encode_long(-2147483648),
            &[0x80, 0x80, 0x80, 0x80, 0xf8, 0xff, 0xff, 0xff, 0xff, 0x01]
        );
        assert_eq!(
            encode_long(-9223372036854775808),
    ...
    fn decode_longs() {
        ...
        assert_eq!(
            decode_long(&[0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01]),
            -1
        );
        assert_eq!(
